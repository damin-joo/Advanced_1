...
#font
game_font = pygame.font.Font(None, 40)      #new font with font type and size
...
while running:
    ...
    screen.blit(background, (0, 0))     #draw backgrounds (position x, y)
    screen.blit(character, (character_x_pos, character_y_pos))
    screen.blit(enemy, (enemy_x_pos, enemy_y_pos))

    #timer
    elasped_time = (pygame.time.get_ticks() - start_ticks) / 1000       #elasped time / 1000 (ms -> s)
    timer = game_font.render(str(int(total_time - elasped_time)), True, (255, 255, 255))         #time (string, True, font color)
...
pygame.time.delay(2000)     #delay 2s
